...
<script>
    ...
    $(document).ready(function() {
        ...
        let checkupList     = getTableData(
            ...
            `cu.*, p.firstname AS p_firstname, p.middlename AS p_middlename, p.lastname AS p_lastname, p.suffix AS p_suffix, p.gender AS p_gender, p.age AS p_age, y.name AS year_name, p.section AS p_section, c.name AS c_name, p.patient_type_id AS p_patient_type_id`);
